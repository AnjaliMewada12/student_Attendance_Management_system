...
<form method="post" action="checkLoginStudent">
		<table style="width:500px;height:500px;border:5px solid whitesmoke;margin:0px auto;background-color:whitesmoke;padding:10px;margin-top:50px;border-radius:30px;">
            ...
            <tr>
				<td colspan="2"><center><input type="text" name="roll" placeholder="Enter the Roll number" style="border-radius:22px;padding:10px;"></center></td>
			</tr>
			<tr>
            ...
            <tr><td>
                <center>
                    <a href="signup1.jsp"><p style="color: darkblue;font-size: 120%;">Create an account</p></a>
                    </center>
                    </td>   
                 <td>
                     <center>
                        <a href="forgot.jsp"><p style="color: darkblue;font-size:120%;">forgot password</p></a>
                   </center> </td>
        </tr>
		</table>
    </form>
