...
<form class="example" method="post" action="addSub">
...
<div style="justify-content:center;align-items:center;display:flex;">
 <input type="text" placeholder="subject to add" name="search"/>
 <input style="font-size:15px;" type="submit" value="add" name="add"/>
 <span style="color:red;">${error}</span>
</div>
</form>
</body>
